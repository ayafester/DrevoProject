    ...
    public partial class RegForm : Form
    {
        ...
        private void btOK_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (read.Read())
                {
                    DataClass.ID = read["id"].ToString();
                }
                read.Close();



                sql.command.CommandText = "INSERT INTO Card ('surname', 'name', 'middlename', 'gender', 'birthday', 'idCreator') VALUES ('" +
                    Surname + "' , '" +
                    NamePerson + "' , '" +
                    Middlename + "' , '" +
                    Gender + "' , '" +
                ...
                sql.command.CommandText = "SELECT * FROM Card WHERE surname='" + Surname + "'  AND name='" + NamePerson + "'  AND middlename='" + Middlename + "' ";
